...
<h1 style="text-align: center;font-family: 'Adobe 楷体 Std R';color: #a90313">图 书 馆</h1>
...
<div class="panel panel-default" id="login">
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <input typr="text" class="form-control" id="code" placeholder="请输入验证码">
            <img name="randImage" id="randImage" onclick="javascript:void(0);">
        </div>
        <script type="text/javascript">
            $(function () {
                $("#randImage").attr("src", "verifyImage");
            });
            $("#randImage").click(function () {
                $(this).attr("src", "verifyImage")
            })
...
<script>
    ...
    $("#loginButton").click(function () {
        ...
        var code = $("#code").val();
        //加密
        var key = CryptoJS.enc.Utf8.parse(code + code + code + code);
        var srcs = CryptoJS.enc.Utf8.parse(passwd);
